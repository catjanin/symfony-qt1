...
class __TwigTemplate_4303f4281b864ea8157bdf4c675809e50abc1d9c397897739360318353a71aea extends \Twig\Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo " - Category : ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 9, $this->source); })()), "category", [], "any", false, false, false, 9), "name", [], "any", false, false, false, 9), "html", null, true);
        echo "</h2>
            <p>";
        // line 10
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 14, $this->source); })()), "tags", [], "any", false, false, false, 14));
...
";
    ...
    {
        return array (  127 => 20,  124 => 19,  117 => 17,  109 => 15,  104 => 14,  97 => 10,  91 => 9,  84 => 6,  75 => 5,  57 => 3,  35 => 1,);
    }
...
{% block body %}
    <h1>{{ slug }}</h1>
        ...
        <div>
            <h2>{{ article.title }} - Category : {{ article.category.name }}</h2>
            <p>{{ article.content }}</p>
        </div>
        <strong>Tags :</strong>
        <ul>
