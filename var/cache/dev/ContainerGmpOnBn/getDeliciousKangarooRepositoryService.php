...
// Returns the private 'App\Repository\DeliciousKangarooRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DeliciousKangarooRepository.php';

return $this->privates['App\\Repository\\DeliciousKangarooRepository'] = new \App\Repository\DeliciousKangarooRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
